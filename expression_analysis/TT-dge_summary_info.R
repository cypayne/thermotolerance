...
### BRAIN 22c
brain_dge_22c <- read.csv("input_files/TT-brain-22c-xbirch-gtf_DGE_lfc-shr_all.csv_with-F1info.csv")
...
## brain 22c: how many genes are misexpressed in f1s? 521 / 
...
### BRAIN 33c
brain_dge_33c <- read.csv("input_files/TT-brain-33c-xbirch-gtf_DGE_lfc-shr_all.csv_with-F1info.csv")
...
# total genes: 24173
# 22C: 521/24173 = 0.0216 = 2.16%
# 33C: 144/24173 = 0.0060 = 0.6%
...
### LIVER 22c
liver_dge_22c <- read.csv("input_files/TT-liver-22c-xbirch-gtf_DGE_lfc-shr_all.csv_with-F1info.csv")
...
### LIVER 33c
liver_dge_33c <- read.csv("input_files/TT-liver-33c-xbirch-gtf_DGE_lfc-shr_all.csv_with-F1info.csv")
...
# total genes: 24173
# 22C: 10/24173 = 0.0004 = 0.04%
# 33C: 96/24173 = 0.0040 = 0.40%
# both temps: 96+10=116 --> 116/24173 = 0.0048 = 0.48% genes misexpressed in at least one thermal context
